...
╠══[Facebook                 • Md Akash islam ]   ║  \033[1;97m  
...
def Subscraption():
	...
	r1=requests.get("https://github.com/RX-AKASH-0/Paid/tree/main").text
	if keyXD in rXD:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m AKASH King, ToOLs Daily Update")
		...
		os.system('am start https://t.me/AKASH_ON_FIRE_99?text=' + tks)
		Subscraption() 
Subscraption() 
login()